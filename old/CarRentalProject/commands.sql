...
('UltraSports', '2','199.99','204.99','1399.93','5','7','9'),
('Economy', '3','39.99','44.99','279.93','3','5','7'),
...
select cars.CarName from cars where capacity > 3 and cars.CarName NOT IN (select CarName from transaction where startdate > '2018-10-27' and enddate < '2018-10-29' and starttime >= '09:00:00' and enddate <= '10:00:00')  ;

select CarName from test.reservedcars where Startdate > '2018-10-27' and EndDate < '2018-10-29' and Starttime >= '09:00:00' and EndTime <= '10:00:00'