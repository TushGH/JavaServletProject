...
public class user {
	...
	public void setuser(String username, String password, String fullName, String role, String licence, String dOB,
	...
	private String validateAddress (String Address) {
		...
		if (!stringSize(Address,1,10))
			{result= "Your Address must be between 1 and 10 characters";}
  ...
  private String validatepassword(String password)
  {
	  ...
	  if (!stringSize(password,6,10))
			{result= "Your password must be between 6 and 10 characters";}
