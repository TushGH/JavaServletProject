...
CREATE TABLE reserved cars (Confirmationid int, CarName varchar(100), Username varchar(100), Starttime time, Startdate date, Endtime time, EndDate Date);

Data into the car table:
