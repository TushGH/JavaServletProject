...
<form action="${pageContext.request.contextPath}/SearchcarControl"  method="post">
<table>
	<tr><td>Select start time:</td><td> <input type="text" name="starttime" id="starttime"></td></tr>
	<tr><td>Select start date: </td><td><input type="text" name="startdate" id="startdate"></td></tr>
	<tr><td>Select end time: </td><td><input type="text" name="startdate" id="endtime"></td></tr>
	<tr><td>Select end date: </td><td><input type="text" name="startdate" id="enddate"></td></tr>
	<tr><td>Passengers : </td><td> <input type="text" name="passengers" id="passenger"/></td></tr>
	
</table>
<br>
<br>
<input type="submit"  name = "submit" value = "searchcar" /></form>
</body>
</html>